...
const THEME_VERSION = '2026.09.08.3';
...
const DESIGN_SYSTEM = `${PUBLIC_ROOT}assets/skunkworks-design-system.css?v=2026.09.08.3&rev=2026.09.08.3`;
...
function stripManagedAssets(html) {
  ...
  do {
    ...
    next = replaceToFixpoint(next, /<link\b[^>]*(?:academy-page-contract\.css|skunkworks-design-system\.css|skunkworks-accessibility\.css|hero-contrast-fix\.css|data-skunkworks-page-contract\s*=\s*["']css["']|data-skunkworks-design-system|data-skunkworks-accessibility)[^>]*>\s*/gi);
...
console.log('Academy theme foundation: consolidated in academy-brand-theme.css.');
